...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(1447, 2048), (2172, 3072)], multiscale_mode='value', keep_ratio=True),
    # dict(type='Resize', img_scale=(2894, 4096), keep_ratio=True),
    dict(
        type='RandomCrop',
        crop_type='relative',
        crop_size=(0.5, 0.5),
