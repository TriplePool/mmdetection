...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'Tr01.json',
        img_prefix=data_root + 'Tr01/',
        pipeline=train_pipeline,
        classes=classes),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'Va01.json',
        img_prefix=data_root + 'Va01/',
        pipeline=test_pipeline,
        classes=classes),
    test=dict(
        type=dataset_type,
        ann_file=data_root + 'Ts01.json',
        img_prefix=data_root + 'Ts01/',
        pipeline=test_pipeline,
        classes=classes))
